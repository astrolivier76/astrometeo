...
void enterLightSleep() {
    ...
    // RETRAIT DÉFINITIF DE esp_light_sleep_start()
}
...
void setup() {
    ...
    server.on("/readings", HTTP_GET, [](AsyncWebServerRequest *request) {
        ...
        if (xSemaphoreTake(xSensorDataMutex, pdMS_TO_TICKS(100)) == pdTRUE) {
            ...
            response->printf(
                "{\"temperature\":%.2f,\"pression\":%.2f,\"humidity\":%.2f,\"dewpoint\":%.2f,\"skyT\":%.2f,\"nuages\":%.1f,\"safe\":%.1f,\"lux\":%.1f,\"sqm\":%.1f,\"k1\":%.1f,\"k2\":%.1f,\"k3\":%.1f,\"k4\":%.1f,\"k5\":%.1f,\"k6\":%.1f,\"k7\":%.1f,\"temp_ciel_clair\":%.1f,\"temp_ciel_couvert\":%.1f,\"Vent\":%.2f,\"Pluie\":%.3f,\"Gouttes\":%d,\"lux_threshold_chauffage\":%.1f,\"chauffage\":%d,\"corr_temp\":%.2f,\"corr_press\":%.2f,\"capteur_ambiant\":%d}",
                ...
                luxThresholdChauffage, chauffage,
...
void updateSensorCache() {
    ...
    updateBME();
    updateSHT(); // Les sondes sont interrogées, le système fera le tri ensuite
    updateTSL2591();
    ...
    // Si l'utilisateur choisit la sonde SHT, on prend son humidité. S'il n'en a pas ou s'il utilise le BME, on se rabat sur le BME
...
void formatWebSocketData(const SensorData& data, char* buffer, size_t bufferSize) {
    snprintf(buffer, bufferSize, 
             "{\"temperature\":%.2f,\"pression\":%.2f,\"humidity\":%.2f,\"dewpoint\":%.2f,\"skyT\":%.2f,\"nuages\":%.1f,\"safe\":%.1f,\"lux\":%.1f,\"sqm\":%.1f,\"Vent\":%.2f,\"Pluie\":%.3f,\"Gouttes\":%d,\"k1\":%.1f,\"k2\":%.1f,\"k3\":%.1f,\"k4\":%.1f,\"k5\":%.1f,\"k6\":%.1f,\"k7\":%.1f,\"temp_ciel_clair\":%.1f,\"temp_ciel_couvert\":%.1f,\"lux_threshold_chauffage\":%.1f,\"chauffage\":%d}",
